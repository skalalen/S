...
import "https://github.com/skalalen/V2/blob/main/MechsEVM2.sol";
import "@openzeppelin/contracts/token/ERC721/IERC721Receiver.sol";
import "@openzeppelin/contracts/token/ERC721/extensions/ERC721Enumerable.sol";

contract MechsStakeV2 is Ownable, IERC721Receiver {
  ...
  mapping(uint256 => Stake) public vault; 
   ...
   constructor(ERC721Enumerable _nft, MechsEVM2 _token) { 
    nft = _nft;
    token = _token;
  }
