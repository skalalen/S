...
const Web3Alc = createAlchemyWeb3("https://polygon-mumbai.g.alchemy.com/v2/cE3yEXl6jD672JZrTtm_g3JjWjSGX_kH");

const moralisapikey = "zglKCYyqp658UwQbzpIjUjspQJznpktmDX6P0HqjblHsNQS71wrveTF90RYgFNk0";
const polygonscanapikey = "QGU4MK5EEA22RM8CI1PI568KWKB7J7N9UB";
...
const refreshPage = ()=>{
  ...
  return (
    <div className="App nftapp backapp">
        <nav class="navbar navbarfont navbarglow navbar-expand-md navbar-dark bg-dark mb-4">
          <div class="container-fluid" style={{ fontFamily: "SF Pro Display" }}>
            <a class="navbar-brand px-5" style={{ fontWeight: "800", fontSize: '25px' }} href="#"></a><img src="matic.png" width="7%" />
        ...
        <div className='container container-style'>
          ...
          <form>
            ...
            <h6 className="pt-2" style={{ fontFamily: "SF Pro Display", fontWeight: "300", fontSize: "18px" }}>Mint Nft!</h6>
        ...
        <div className='col'>
          <body className='nftstaker border-0'>
            <form  style={{ fontFamily: "SF Pro Display" }} >
              <h2 style={{ borderRadius: '14px', fontWeight: "300", fontSize: "25px" }}>Mechs NFT Staking Vault </h2>
              ...
              <div className="row px-3">
                <div className="col">
                  ...
                  <div className="col">
                    <form className='stakingrewards' style={{ borderRadius: "25px", boxShadow: "1px 1px 15px #ffffff", fontFamily: "SF Pro Display" }}>
                      ...
                      <Button onClick={rewardinfo} style={{ backgroundColor: "#ffffff10", boxShadow: "1px 1px 5px #000000" }} >Earned MCH Rewards</Button>
                ...
                <div className="row px-4 pt-2">
                  <div class="header">
                    <div style={{ fontSize: '25px', borderRadius: '14px', color: "#ffffff", fontWeight: "300" }}>MECHS NFT Staking Pool Active Rewards</div>
                    <table className='table px-3 table-bordered table-dark'>
                      ...
                      <tbody>
                        <tr>
                          <td>MECHS Bronze Collection</td>
                          <td class="amount" data-test-id="rewards-summary-ads">
                            <span class="amount">0.50</span>&nbsp;<span class="currency">MCH</span>
                          </td>
                          <td class="exchange">
                        ...
                        <tr>
                          <td>MECHS Silver Collection</td>
                          <td class="amount" data-test-id="rewards-summary-ac">
                            <span class="amount">2.50</span>&nbsp;<span class="currency">MCH</span>
                          </td>
                          <td class="exchange"><span class="amount">10</span>&nbsp;<span class="currency">NFTs/M</span>
                          </td>
                        </tr>
                        <tr className='stakegoldeffect'>
                          <td>MECHS Gold Collection</td>
                          <td class="amount" data-test-id="rewards-summary-one-time"><span class="amount">1</span>&nbsp;<span class="currency">MCH BTC</span>
                          </td>
                          <td class="exchange">
                            <span class="amount">25 NFTs/M or </span>
                            <span class="currency">100 MCHS/M</span>
                          </td>
                        </tr>
                      </tbody>
                    </table>
                    ...
                    <div class="header">
                      <div style={{ fontSize: '25px', borderRadius: '14px', fontWeight: '300' }}>MCH Token Stake Farms</div>
                      <table className='table table-bordered table-dark' style={{ borderRadius: '14px' }} >
                        ...
                        <tbody>
                          <tr>
                            <td>Stake MCH to Earn MCH</td>
                            <td class="amount" data-test-id="rewards-summary-ads">
                              <span class="amount">0.01</span>&nbsp;<span class="currency">Per MCH</span>
                            </td>
                          </tr>
                          <tr>
                            <td>Stake MCH to Earn BTC</td>
                            <td class="amount" data-test-id="rewards-summary-ac">
                              <span class="amount">0.005</span>&nbsp;<span class="currency">Per MCH</span>
                            </td>
                          </tr>
                        </tbody>
                      </table>
      ...
      <div className='col'>
        <h1 className='n2dtitlestyle mt-3'>My NFT's</h1>
      <Button onClick={refreshPage} style={{ backgroundColor: "#000000", boxShadow: "1px 1px 5px #000000" }}>Refresh my Nft's</Button>
      </div>
